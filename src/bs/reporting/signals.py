"""Export participant raw and standardized signals in a shared table."""
...
# [설정 영역]
BASE_DIR = str(path('features_dir'))
OUTPUT_DIR = str(path('signals_dir')) # 최종 폴더명

TIMELINE_INFO_PATH = str(path('timeline_metadata'))
SESSION_TIMELINE_PATH = str(path('session_metadata'))
